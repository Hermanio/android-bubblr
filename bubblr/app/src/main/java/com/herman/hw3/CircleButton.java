 ...
 */
public class CircleButton extends AdvancedButton {



    public CircleButton(Context context, AttributeSet attrs, long period) {
        super(context, attrs, period);

        setBackgroundResource(R.drawable.circle_button);
        //this.getBackground().setColorFilter(0xFFFF00, PorterDuff.Mode.MULTIPLY);
    }
